...
| Azure SQL Managed Instance to Azure AD Resource Provider | 9c8b80bc-6887-42d0-b1af-d0c40f9bf1fa | Platform as a service (PaaS) that offers cloud-enhanced SQL Server within an isolated private virtual network environment. |
...
| Dynamics Lifecycle services | 913c6de4-2a4a-4a61-a9ce-945d2b2ce2e0 | An Azure-based portal that provides a unifying, collaborative environment for customers and partners to manage the application lifecycle of their Microsoft Dynamics implementations. |
...
| Microsoft Volume Licensing | b4ec8d8b-0275-4833-8568-690db4af4b45 | Commerce platform that supports the Microsoft Product and Services Agreement (MPSA), which is a transactional licensing agreement for commercial, government, and academic organizations with 250 or more users/devices. |
...
| Power Virtual Agents Service | 9d8f559b-5984-46a4-902a-ad4271e83efa | Power Virtual Agents is the former name for Microsoft Copilot Studio. Both instances of this app allow the service to manage the applications and service principals created for each agent. |
